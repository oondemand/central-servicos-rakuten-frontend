...
const TicketForm = ({ isEditMode, ticket, closeModal }) => {
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    ...
    if (isEditMode) {
      const servico = {
        _id: ticket.servico._id,
        ...values.servico,
      };
      console.log("servico", servico);
      const sucessoServico = await salvarServico(servico);
      console.log("sucessoServico", sucessoServico);
      ...
      console.log("sucessoTicket", sucesso);
      setSubmitting(false);
      if (sucesso) {
        closeModal();
      }
      ...
      if (sucessoServico) {
        ...
        console.log("sucessoTicket", sucessoTicket);
        // setSubmitting(false);
        // return;
